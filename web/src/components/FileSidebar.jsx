  ...
  return (
    <aside className="w-[280px] shrink-0 border-r border-app-border/80 overflow-hidden bg-[color-mix(in_oklab,var(--app-bg)_82%,var(--app-surface))] min-h-0 flex flex-col">
      ...
      <div className="flex-1 min-h-0 flex flex-col overflow-hidden">
        <div className="overflow-y-auto px-3 pt-2 pb-3 flex-1 min-h-0 space-y-2">
            ...
            return (
              <button
                ...
                className={[
                  ...
                  'ring-1 ring-inset',
                  isActive
                    ? 'bg-app-surface shadow-none ring-[color-mix(in_oklab,var(--app-fg)_10%,transparent)] text-app-fg dark:ring-white/10 dark:shadow-none'
