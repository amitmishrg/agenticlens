...
/** Main trace workspace (after leaving the marketing landing page). */
export default function AppWorkspace() {
  ...
  const useMinimalChrome = showAutoLoading || (showUploadPanel && showEmptyUpload);

  return (
    <div className="relative isolate flex h-screen min-h-0 flex-col overflow-hidden bg-transparent text-app-fg">
